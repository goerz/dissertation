...
def create_figure(outfile, runfolder):
    ...
    plot.plot(basis_states=('01', ), pops=('00', '01', '10', '11', 'tot' ),
              fig=fig, in_panel_legend=True)

    set_axis(plot.ax['01']['pop'],    'x', 0, 400, 50, minor=5)
    set_axis(plot.ax['01']['q1'],     'x', 0, 400, 50, minor=5)
    set_axis(plot.ax['01']['q2'],     'x', 0, 400, 50, minor=5)
    set_axis(plot.ax['01']['pop'],   'y', 0, 1.0, 0.5, range=(0,1.3),  minor=5)
    set_axis(plot.ax['01']['q1'],    'y', 0, 1.9, 0.5, minor=5)
    set_axis(plot.ax['01']['q2'],    'y', 0, 1.9, 0.5, minor=5)
