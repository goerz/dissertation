...
In general, our exact understanding of why quantum algorithms can outperform
...
the standard gate model, i.e.\ ``special-purpose'' quantum computers. Such
machines gener

adiabatic~\cite{FarhiS2001}
adiabatic is general~\cite{Aharonov2004}

DWave~\cite{JohnsonN2011}


criticism~\cite{DamNP2007, RonnowS2014, ShinArXiv1401.7087}

machine learning~\cite{NevenArXiv0912.0779,NevenArXiv0804.4457}

% The difference between the two is that the adiabatic algorithm runs
% coherently, at zero temperature, while quantum annealing is a “messier”
% version in which the qubits are strongly coupled to their environment
% throughout, but still maintain some quantum coherence.)
...
\end{equation}
In all the cases we consider, the goal is to limit or circumvent the effects of
decoherence.
...
Both algorithms rely on phase relation
