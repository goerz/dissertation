...
def create_figure(outfile, runfolder):
    ...
    set_axis(plot.ax['00']['pop'],    'x', 0, 120, 20, minor=5)
    set_axis(plot.ax['00']['q1'],     'x', 0, 120, 20, minor=5)
    set_axis(plot.ax['00']['q2'],     'x', 0, 120, 20, minor=5)
    set_axis(plot.ax['00']['cavity'], 'x', 0, 120, 20, minor=4)
    set_axis(plot.ax['00']['pop'],   'y', 0, 1.0, 0.5, range=(0,1.5),  minor=5)
    set_axis(plot.ax['00']['q1'],    'y', 0, 0.38, 0.2,                minor=5)
    set_axis(plot.ax['00']['q2'],    'y', 0, 0.38, 0.2,                minor=5)
    set_axis(plot.ax['00']['cavity'],'y', 0, 13,  5,                   minor=5)
